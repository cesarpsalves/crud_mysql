...
class PagamentoDAO{
	...
	public function cadastrar($pagamento){
		include("../conexao/conexao.php");
		$sql = 'INSERT INTO pagamento (reg_data_pagamento, situacao, data_alteracao, data_cadastro, id_usuario) VALUES (:reg_data_pagamento, :situacao, :data_alteracao, :data_cadastro, :id_usuario)';
		$consulta = $conexao->prepare($sql);
